...
\subsection* {The dependency knapsack problem}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{The dependency knapsack problem}{Experiment I} %Frame 1
    \begin{itemize}
...
\begin{frame}{The dependency knapsack problem}{Experiment I} %Frame 2
    \begin{figure}
        \centering
...
\begin{frame}{Real Data}{Experiment II}
    \begin{figure}
        \centering
        \includegraphics[height=6cm]{Figure18v2.png}
...
\begin{frame}{Real Data}{Experiment II}
    \begin{figure}
        \centering
        \includegraphics[height=6cm]{Figure19v2.png}
